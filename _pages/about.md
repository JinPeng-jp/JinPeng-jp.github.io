...
<style>
  .icon-green { color: #28a745; margin-right: 10px; }
  .icon-blue { color: #007bff; margin-right: 10px; }
  .icon-gold { color: #ffc107; margin-right: 10px; }
...
- <i class="fas fa-calendar-check icon-blue"></i> **2022.09 - Present**: Huazhong University of Science and Technology (HUST), Wuhan, Hubei, China

## <i class="fas fa-trophy icon-gold"></i> Academic Achievements
- <i class="fas fa-star icon-gold"></i> **Weighted Score**: 89.15
- <i class="fas fa-chart-line icon-gold"></i> **Rank**: 6/30
...
- <i class="fas fa-medal icon-gold"></i> **2023 Nov**: Third Prize in HUST Mathematical Modeling Contest
- <i class="fas fa-flag-usa icon-gold"></i> **2024 Feb**: S Prize in American College Mathematics Contest
- <i class="fas fa-shield-alt icon-gold"></i> **2024 Dec**: First Prize in National Information Security and Confrontation Competition (Provincial)
- <i class="fas fa-shield-alt icon-gold"></i> **2024 Dec**: Third Prize in National Information Security and Confrontation Competition (National)

## <i class="fas fa-award icon-green"></i> Other Awards
- <i class="fas fa-certificate icon-gold"></i> **May 2023**: Outstanding Communist Youth League Member, HUST
- <i class="fas fa-money-check-alt icon-gold"></i> **Oct 2023**: Science and Technology Innovation Scholarship 2022-2023
- <i class="fas fa-money-check-alt icon-gold"></i> **Oct 2023**: Excellence in Learning Scholarship 2022-2023
- <i class="fas fa-money-check-alt icon-gold"></i> **Oct 2024**: Self-Improvement Scholarship 2023-2024
- <i class="fas fa-money-check-alt icon-gold"></i> **Oct 2024**: Excellence in Learning Scholarship 2023-2024

---

<i class="fas fa-envelope icon-lg"></i> Feel free to contact me via [<i class="fas fa-paper-plane icon-blue"></i> email](mailto:u202214066@hust.edu.cn).
